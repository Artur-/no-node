(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerpolicy&&(r.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?r.credentials="include":a.crossorigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();window.Vaadin=window.Vaadin||{};window.Vaadin.featureFlags=window.Vaadin.featureFlags||{};window.Vaadin.featureFlags.exampleFeatureFlag=!1;window.Vaadin.featureFlags.spreadsheetComponent=!1;window.Vaadin.featureFlags.hillaPush=!1;window.Vaadin.featureFlags.hillaEngine=!1;window.Vaadin.featureFlags.oldLicenseChecker=!1;window.Vaadin.featureFlags.collaborationEngineBackend=!1;window.Vaadin.featureFlags.webpackForFrontendBuild=!1;window.Vaadin.featureFlags.enforceFieldValidation=!1;const po="modulepreload",go=function(o,e){return new URL(o,e).href},ct={},We=function(e,t,n){return!t||t.length===0?e():Promise.all(t.map(a=>{if(a=go(a,n),a in ct)return;ct[a]=!0;const r=a.endsWith(".css"),l=r?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${a}"]${l}`))return;const c=document.createElement("link");if(c.rel=r?"stylesheet":po,r||(c.as="script",c.crossOrigin=""),c.href=a,document.head.appendChild(c),r)return new Promise((i,f)=>{c.addEventListener("load",i),c.addEventListener("error",()=>f(new Error(`Unable to preload CSS for ${a}`)))})})).then(()=>e())};function Le(o){return o=o||[],Array.isArray(o)?o:[o]}function T(o){return`[Vaadin.Router] ${o}`}function wo(o){if(typeof o!="object")return String(o);const e=Object.prototype.toString.call(o).match(/ (.*)\]$/)[1];return e==="Object"||e==="Array"?`${e} ${JSON.stringify(o)}`:e}const Se="module",Ee="nomodule",Ge=[Se,Ee];function st(o){if(!o.match(/.+\.[m]?js$/))throw new Error(T(`Unsupported type for bundle "${o}": .js or .mjs expected.`))}function Bt(o){if(!o||!F(o.path))throw new Error(T('Expected route config to be an object with a "path" string property, or an array of such objects'));const e=o.bundle,t=["component","redirect","bundle"];if(!M(o.action)&&!Array.isArray(o.children)&&!M(o.children)&&!$e(e)&&!t.some(n=>F(o[n])))throw new Error(T(`Expected route config "${o.path}" to include either "${t.join('", "')}" or "action" function but none found.`));if(e)if(F(e))st(e);else if(Ge.some(n=>n in e))Ge.forEach(n=>n in e&&st(e[n]));else throw new Error(T('Expected route bundle to include either "'+Ee+'" or "'+Se+'" keys, or both'));o.redirect&&["bundle","component"].forEach(n=>{n in o&&console.warn(T(`Route config "${o.path}" has both "redirect" and "${n}" properties, and "redirect" will always override the latter. Did you mean to only use "${n}"?`))})}function dt(o){Le(o).forEach(e=>Bt(e))}function mt(o,e){let t=document.head.querySelector('script[src="'+o+'"][async]');return t||(t=document.createElement("script"),t.setAttribute("src",o),e===Se?t.setAttribute("type",Se):e===Ee&&t.setAttribute(Ee,""),t.async=!0),new Promise((n,a)=>{t.onreadystatechange=t.onload=r=>{t.__dynamicImportLoaded=!0,n(r)},t.onerror=r=>{t.parentNode&&t.parentNode.removeChild(t),a(r)},t.parentNode===null?document.head.appendChild(t):t.__dynamicImportLoaded&&n()})}function vo(o){return F(o)?mt(o):Promise.race(Ge.filter(e=>e in o).map(e=>mt(o[e],e)))}function ae(o,e){return!window.dispatchEvent(new CustomEvent(`vaadin-router-${o}`,{cancelable:o==="go",detail:e}))}function $e(o){return typeof o=="object"&&!!o}function M(o){return typeof o=="function"}function F(o){return typeof o=="string"}function Mt(o){const e=new Error(T(`Page not found (${o.pathname})`));return e.context=o,e.code=404,e}const X=new class{};function yo(o){const e=o.port,t=o.protocol,r=t==="http:"&&e==="80"||t==="https:"&&e==="443"?o.hostname:o.host;return`${t}//${r}`}function bt(o){if(o.defaultPrevented||o.button!==0||o.shiftKey||o.ctrlKey||o.altKey||o.metaKey)return;let e=o.target;const t=o.composedPath?o.composedPath():o.path||[];for(let c=0;c<t.length;c++){const i=t[c];if(i.nodeName&&i.nodeName.toLowerCase()==="a"){e=i;break}}for(;e&&e.nodeName.toLowerCase()!=="a";)e=e.parentNode;if(!e||e.nodeName.toLowerCase()!=="a"||e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||e.hasAttribute("router-ignore")||e.pathname===window.location.pathname&&e.hash!==""||(e.origin||yo(e))!==window.location.origin)return;const{pathname:a,search:r,hash:l}=e;ae("go",{pathname:a,search:r,hash:l})&&(o.preventDefault(),o&&o.type==="click"&&window.scrollTo(0,0))}const xo={activate(){window.document.addEventListener("click",bt)},inactivate(){window.document.removeEventListener("click",bt)}},_o=/Trident/.test(navigator.userAgent);_o&&!M(window.PopStateEvent)&&(window.PopStateEvent=function(o,e){e=e||{};var t=document.createEvent("Event");return t.initEvent(o,Boolean(e.bubbles),Boolean(e.cancelable)),t.state=e.state||null,t},window.PopStateEvent.prototype=window.Event.prototype);function ut(o){if(o.state==="vaadin-router-ignore")return;const{pathname:e,search:t,hash:n}=window.location;ae("go",{pathname:e,search:t,hash:n})}const Ao={activate(){window.addEventListener("popstate",ut)},inactivate(){window.removeEventListener("popstate",ut)}};var te=Wt,ko=Ye,Lo=Co,So=Dt,Eo=Ht,jt="/",Ut="./",$o=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function Ye(o,e){for(var t=[],n=0,a=0,r="",l=e&&e.delimiter||jt,c=e&&e.delimiters||Ut,i=!1,f;(f=$o.exec(o))!==null;){var u=f[0],b=f[1],m=f.index;if(r+=o.slice(a,m),a=m+u.length,b){r+=b[1],i=!0;continue}var h="",O=o[a],$=f[2],be=f[3],Te=f[4],E=f[5];if(!i&&r.length){var R=r.length-1;c.indexOf(r[R])>-1&&(h=r[R],r=r.slice(0,R))}r&&(t.push(r),r="",i=!1);var U=h!==""&&O!==void 0&&O!==h,D=E==="+"||E==="*",Re=E==="?"||E==="*",P=h||l,ue=be||Te;t.push({name:$||n++,prefix:h,delimiter:P,optional:Re,repeat:D,partial:U,pattern:ue?zo(ue):"[^"+q(P)+"]+?"})}return(r||a<o.length)&&t.push(r+o.substr(a)),t}function Co(o,e){return Dt(Ye(o,e))}function Dt(o){for(var e=new Array(o.length),t=0;t<o.length;t++)typeof o[t]=="object"&&(e[t]=new RegExp("^(?:"+o[t].pattern+")$"));return function(n,a){for(var r="",l=a&&a.encode||encodeURIComponent,c=0;c<o.length;c++){var i=o[c];if(typeof i=="string"){r+=i;continue}var f=n?n[i.name]:void 0,u;if(Array.isArray(f)){if(!i.repeat)throw new TypeError('Expected "'+i.name+'" to not repeat, but got array');if(f.length===0){if(i.optional)continue;throw new TypeError('Expected "'+i.name+'" to not be empty')}for(var b=0;b<f.length;b++){if(u=l(f[b],i),!e[c].test(u))throw new TypeError('Expected all "'+i.name+'" to match "'+i.pattern+'"');r+=(b===0?i.prefix:i.delimiter)+u}continue}if(typeof f=="string"||typeof f=="number"||typeof f=="boolean"){if(u=l(String(f),i),!e[c].test(u))throw new TypeError('Expected "'+i.name+'" to match "'+i.pattern+'", but got "'+u+'"');r+=i.prefix+u;continue}if(i.optional){i.partial&&(r+=i.prefix);continue}throw new TypeError('Expected "'+i.name+'" to be '+(i.repeat?"an array":"a string"))}return r}}function q(o){return o.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function zo(o){return o.replace(/([=!:$/()])/g,"\\$1")}function Vt(o){return o&&o.sensitive?"":"i"}function Fo(o,e){if(!e)return o;var t=o.source.match(/\((?!\?)/g);if(t)for(var n=0;n<t.length;n++)e.push({name:n,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return o}function To(o,e,t){for(var n=[],a=0;a<o.length;a++)n.push(Wt(o[a],e,t).source);return new RegExp("(?:"+n.join("|")+")",Vt(t))}function Ro(o,e,t){return Ht(Ye(o,t),e,t)}function Ht(o,e,t){t=t||{};for(var n=t.strict,a=t.start!==!1,r=t.end!==!1,l=q(t.delimiter||jt),c=t.delimiters||Ut,i=[].concat(t.endsWith||[]).map(q).concat("$").join("|"),f=a?"^":"",u=o.length===0,b=0;b<o.length;b++){var m=o[b];if(typeof m=="string")f+=q(m),u=b===o.length-1&&c.indexOf(m[m.length-1])>-1;else{var h=m.repeat?"(?:"+m.pattern+")(?:"+q(m.delimiter)+"(?:"+m.pattern+"))*":m.pattern;e&&e.push(m),m.optional?m.partial?f+=q(m.prefix)+"("+h+")?":f+="(?:"+q(m.prefix)+"("+h+"))?":f+=q(m.prefix)+"("+h+")"}}return r?(n||(f+="(?:"+l+")?"),f+=i==="$"?"$":"(?="+i+")"):(n||(f+="(?:"+l+"(?="+i+"))?"),u||(f+="(?="+l+"|"+i+")")),new RegExp(f,Vt(t))}function Wt(o,e,t){return o instanceof RegExp?Fo(o,e):Array.isArray(o)?To(o,e,t):Ro(o,e,t)}te.parse=ko;te.compile=Lo;te.tokensToFunction=So;te.tokensToRegExp=Eo;const{hasOwnProperty:Oo}=Object.prototype,Ke=new Map;Ke.set("|false",{keys:[],pattern:/(?:)/});function ht(o){try{return decodeURIComponent(o)}catch{return o}}function Po(o,e,t,n,a){t=!!t;const r=`${o}|${t}`;let l=Ke.get(r);if(!l){const f=[];l={keys:f,pattern:te(o,f,{end:t,strict:o===""})},Ke.set(r,l)}const c=l.pattern.exec(e);if(!c)return null;const i=Object.assign({},a);for(let f=1;f<c.length;f++){const u=l.keys[f-1],b=u.name,m=c[f];(m!==void 0||!Oo.call(i,b))&&(u.repeat?i[b]=m?m.split(u.delimiter).map(ht):[]:i[b]=m&&ht(m))}return{path:c[0],keys:(n||[]).concat(l.keys),params:i}}function Gt(o,e,t,n,a){let r,l,c=0,i=o.path||"";return i.charAt(0)==="/"&&(t&&(i=i.substr(1)),t=!0),{next(f){if(o===f)return{done:!0};const u=o.__children=o.__children||o.children;if(!r&&(r=Po(i,e,!u,n,a),r))return{done:!1,value:{route:o,keys:r.keys,params:r.params,path:r.path}};if(r&&u)for(;c<u.length;){if(!l){const m=u[c];m.parent=o;let h=r.path.length;h>0&&e.charAt(h)==="/"&&(h+=1),l=Gt(m,e.substr(h),t,r.keys,r.params)}const b=l.next(f);if(!b.done)return{done:!1,value:b.value};l=null,c++}return{done:!0}}}}function qo(o){if(M(o.route.action))return o.route.action(o)}function Io(o,e){let t=e;for(;t;)if(t=t.parent,t===o)return!0;return!1}function No(o){let e=`Path '${o.pathname}' is not properly resolved due to an error.`;const t=(o.route||{}).path;return t&&(e+=` Resolution had failed on route: '${t}'`),e}function Bo(o,e){const{route:t,path:n}=e;if(t&&!t.__synthetic){const a={path:n,route:t};if(!o.chain)o.chain=[];else if(t.parent){let r=o.chain.length;for(;r--&&o.chain[r].route&&o.chain[r].route!==t.parent;)o.chain.pop()}o.chain.push(a)}}class le{constructor(e,t={}){if(Object(e)!==e)throw new TypeError("Invalid routes");this.baseUrl=t.baseUrl||"",this.errorHandler=t.errorHandler,this.resolveRoute=t.resolveRoute||qo,this.context=Object.assign({resolver:this},t.context),this.root=Array.isArray(e)?{path:"",__children:e,parent:null,__synthetic:!0}:e,this.root.parent=null}getRoutes(){return[...this.root.__children]}setRoutes(e){dt(e);const t=[...Le(e)];this.root.__children=t}addRoutes(e){return dt(e),this.root.__children.push(...Le(e)),this.getRoutes()}removeRoutes(){this.setRoutes([])}resolve(e){const t=Object.assign({},this.context,F(e)?{pathname:e}:e),n=Gt(this.root,this.__normalizePathname(t.pathname),this.baseUrl),a=this.resolveRoute;let r=null,l=null,c=t;function i(f,u=r.value.route,b){const m=b===null&&r.value.route;return r=l||n.next(m),l=null,!f&&(r.done||!Io(u,r.value.route))?(l=r,Promise.resolve(X)):r.done?Promise.reject(Mt(t)):(c=Object.assign(c?{chain:c.chain?c.chain.slice(0):[]}:{},t,r.value),Bo(c,r.value),Promise.resolve(a(c)).then(h=>h!=null&&h!==X?(c.result=h.result||h,c):i(f,u,h)))}return t.next=i,Promise.resolve().then(()=>i(!0,this.root)).catch(f=>{const u=No(c);if(f?console.warn(u):f=new Error(u),f.context=f.context||c,f instanceof DOMException||(f.code=f.code||500),this.errorHandler)return c.result=this.errorHandler(f),c;throw f})}static __createUrl(e,t){return new URL(e,t)}get __effectiveBaseUrl(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}__normalizePathname(e){if(!this.baseUrl)return e;const t=this.__effectiveBaseUrl,n=this.constructor.__createUrl(e,t).href;if(n.slice(0,t.length)===t)return n.slice(t.length)}}le.pathToRegexp=te;const{pathToRegexp:pt}=le,gt=new Map;function Kt(o,e,t){const n=e.name||e.component;if(n&&(o.has(n)?o.get(n).push(e):o.set(n,[e])),Array.isArray(t))for(let a=0;a<t.length;a++){const r=t[a];r.parent=e,Kt(o,r,r.__children||r.children)}}function wt(o,e){const t=o.get(e);if(t&&t.length>1)throw new Error(`Duplicate route with name "${e}". Try seting unique 'name' route properties.`);return t&&t[0]}function vt(o){let e=o.path;return e=Array.isArray(e)?e[0]:e,e!==void 0?e:""}function Mo(o,e={}){if(!(o instanceof le))throw new TypeError("An instance of Resolver is expected");const t=new Map;return(n,a)=>{let r=wt(t,n);if(!r&&(t.clear(),Kt(t,o.root,o.root.__children),r=wt(t,n),!r))throw new Error(`Route "${n}" not found`);let l=gt.get(r.fullPath);if(!l){let i=vt(r),f=r.parent;for(;f;){const h=vt(f);h&&(i=h.replace(/\/$/,"")+"/"+i.replace(/^\//,"")),f=f.parent}const u=pt.parse(i),b=pt.tokensToFunction(u),m=Object.create(null);for(let h=0;h<u.length;h++)F(u[h])||(m[u[h].name]=!0);l={toPath:b,keys:m},gt.set(i,l),r.fullPath=i}let c=l.toPath(a,e)||"/";if(e.stringifyQueryParams&&a){const i={},f=Object.keys(a);for(let b=0;b<f.length;b++){const m=f[b];l.keys[m]||(i[m]=a[m])}const u=e.stringifyQueryParams(i);u&&(c+=u.charAt(0)==="?"?u:`?${u}`)}return c}}let yt=[];function jo(o){yt.forEach(e=>e.inactivate()),o.forEach(e=>e.activate()),yt=o}const Uo=o=>{const e=getComputedStyle(o).getPropertyValue("animation-name");return e&&e!=="none"},Do=(o,e)=>{const t=()=>{o.removeEventListener("animationend",t),e()};o.addEventListener("animationend",t)};function xt(o,e){return o.classList.add(e),new Promise(t=>{if(Uo(o)){const n=o.getBoundingClientRect(),a=`height: ${n.bottom-n.top}px; width: ${n.right-n.left}px`;o.setAttribute("style",`position: absolute; ${a}`),Do(o,()=>{o.classList.remove(e),o.removeAttribute("style"),t()})}else o.classList.remove(e),t()})}const Vo=256;function Ie(o){return o!=null}function Ho(o){const e=Object.assign({},o);return delete e.next,e}function C({pathname:o="",search:e="",hash:t="",chain:n=[],params:a={},redirectFrom:r,resolver:l},c){const i=n.map(f=>f.route);return{baseUrl:l&&l.baseUrl||"",pathname:o,search:e,hash:t,routes:i,route:c||i.length&&i[i.length-1]||null,params:a,redirectFrom:r,getUrl:(f={})=>_e(N.pathToRegexp.compile(Jt(i))(Object.assign({},a,f)),l)}}function _t(o,e){const t=Object.assign({},o.params);return{redirect:{pathname:e,from:o.pathname,params:t}}}function Wo(o,e){e.location=C(o);const t=o.chain.map(n=>n.route).indexOf(o.route);return o.chain[t].element=e,e}function xe(o,e,t){if(M(o))return o.apply(t,e)}function At(o,e,t){return n=>{if(n&&(n.cancel||n.redirect))return n;if(t)return xe(t[o],e,t)}}function Go(o,e){if(!Array.isArray(o)&&!$e(o))throw new Error(T(`Incorrect "children" value for the route ${e.path}: expected array or object, but got ${o}`));e.__children=[];const t=Le(o);for(let n=0;n<t.length;n++)Bt(t[n]),e.__children.push(t[n])}function ve(o){if(o&&o.length){const e=o[0].parentNode;for(let t=0;t<o.length;t++)e.removeChild(o[t])}}function _e(o,e){const t=e.__effectiveBaseUrl;return t?e.constructor.__createUrl(o.replace(/^\//,""),t).pathname:o}function Jt(o){return o.map(e=>e.path).reduce((e,t)=>t.length?e.replace(/\/$/,"")+"/"+t.replace(/^\//,""):e,"")}class N extends le{constructor(e,t){const n=document.head.querySelector("base"),a=n&&n.getAttribute("href");super([],Object.assign({baseUrl:a&&le.__createUrl(a,document.URL).pathname.replace(/[^\/]*$/,"")},t)),this.resolveRoute=l=>this.__resolveRoute(l);const r=N.NavigationTrigger;N.setTriggers.apply(N,Object.keys(r).map(l=>r[l])),this.baseUrl,this.ready,this.ready=Promise.resolve(e),this.location,this.location=C({resolver:this}),this.__lastStartedRenderId=0,this.__navigationEventHandler=this.__onNavigationEvent.bind(this),this.setOutlet(e),this.subscribe(),this.__createdByRouter=new WeakMap,this.__addedByRouter=new WeakMap}__resolveRoute(e){const t=e.route;let n=Promise.resolve();M(t.children)&&(n=n.then(()=>t.children(Ho(e))).then(r=>{!Ie(r)&&!M(t.children)&&(r=t.children),Go(r,t)}));const a={redirect:r=>_t(e,r),component:r=>{const l=document.createElement(r);return this.__createdByRouter.set(l,!0),l}};return n.then(()=>{if(this.__isLatestRender(e))return xe(t.action,[e,a],t)}).then(r=>{if(Ie(r)&&(r instanceof HTMLElement||r.redirect||r===X))return r;if(F(t.redirect))return a.redirect(t.redirect);if(t.bundle)return vo(t.bundle).then(()=>{},()=>{throw new Error(T(`Bundle not found: ${t.bundle}. Check if the file name is correct`))})}).then(r=>{if(Ie(r))return r;if(F(t.component))return a.component(t.component)})}setOutlet(e){e&&this.__ensureOutlet(e),this.__outlet=e}getOutlet(){return this.__outlet}setRoutes(e,t=!1){return this.__previousContext=void 0,this.__urlForName=void 0,super.setRoutes(e),t||this.__onNavigationEvent(),this.ready}render(e,t){const n=++this.__lastStartedRenderId,a=Object.assign({search:"",hash:""},F(e)?{pathname:e}:e,{__renderId:n});return this.ready=this.resolve(a).then(r=>this.__fullyResolveChain(r)).then(r=>{if(this.__isLatestRender(r)){const l=this.__previousContext;if(r===l)return this.__updateBrowserHistory(l,!0),this.location;if(this.location=C(r),t&&this.__updateBrowserHistory(r,n===1),ae("location-changed",{router:this,location:this.location}),r.__skipAttach)return this.__copyUnchangedElements(r,l),this.__previousContext=r,this.location;this.__addAppearingContent(r,l);const c=this.__animateIfNeeded(r);return this.__runOnAfterEnterCallbacks(r),this.__runOnAfterLeaveCallbacks(r,l),c.then(()=>{if(this.__isLatestRender(r))return this.__removeDisappearingContent(),this.__previousContext=r,this.location})}}).catch(r=>{if(n===this.__lastStartedRenderId)throw t&&this.__updateBrowserHistory(a),ve(this.__outlet&&this.__outlet.children),this.location=C(Object.assign(a,{resolver:this})),ae("error",Object.assign({router:this,error:r},a)),r}),this.ready}__fullyResolveChain(e,t=e){return this.__findComponentContextAfterAllRedirects(t).then(n=>{const r=n!==t?n:e,c=_e(Jt(n.chain),n.resolver)===n.pathname,i=(f,u=f.route,b)=>f.next(void 0,u,b).then(m=>m===null||m===X?c?f:u.parent!==null?i(f,u.parent,m):m:m);return i(n).then(f=>{if(f===null||f===X)throw Mt(r);return f&&f!==X&&f!==n?this.__fullyResolveChain(r,f):this.__amendWithOnBeforeCallbacks(n)})})}__findComponentContextAfterAllRedirects(e){const t=e.result;return t instanceof HTMLElement?(Wo(e,t),Promise.resolve(e)):t.redirect?this.__redirect(t.redirect,e.__redirectCount,e.__renderId).then(n=>this.__findComponentContextAfterAllRedirects(n)):t instanceof Error?Promise.reject(t):Promise.reject(new Error(T(`Invalid route resolution result for path "${e.pathname}". Expected redirect object or HTML element, but got: "${wo(t)}". Double check the action return value for the route.`)))}__amendWithOnBeforeCallbacks(e){return this.__runOnBeforeCallbacks(e).then(t=>t===this.__previousContext||t===e?t:this.__fullyResolveChain(t))}__runOnBeforeCallbacks(e){const t=this.__previousContext||{},n=t.chain||[],a=e.chain;let r=Promise.resolve();const l=()=>({cancel:!0}),c=i=>_t(e,i);if(e.__divergedChainIndex=0,e.__skipAttach=!1,n.length){for(let i=0;i<Math.min(n.length,a.length)&&!(n[i].route!==a[i].route||n[i].path!==a[i].path&&n[i].element!==a[i].element||!this.__isReusableElement(n[i].element,a[i].element));i=++e.__divergedChainIndex);if(e.__skipAttach=a.length===n.length&&e.__divergedChainIndex==a.length&&this.__isReusableElement(e.result,t.result),e.__skipAttach){for(let i=a.length-1;i>=0;i--)r=this.__runOnBeforeLeaveCallbacks(r,e,{prevent:l},n[i]);for(let i=0;i<a.length;i++)r=this.__runOnBeforeEnterCallbacks(r,e,{prevent:l,redirect:c},a[i]),n[i].element.location=C(e,n[i].route)}else for(let i=n.length-1;i>=e.__divergedChainIndex;i--)r=this.__runOnBeforeLeaveCallbacks(r,e,{prevent:l},n[i])}if(!e.__skipAttach)for(let i=0;i<a.length;i++)i<e.__divergedChainIndex?i<n.length&&n[i].element&&(n[i].element.location=C(e,n[i].route)):(r=this.__runOnBeforeEnterCallbacks(r,e,{prevent:l,redirect:c},a[i]),a[i].element&&(a[i].element.location=C(e,a[i].route)));return r.then(i=>{if(i){if(i.cancel)return this.__previousContext.__renderId=e.__renderId,this.__previousContext;if(i.redirect)return this.__redirect(i.redirect,e.__redirectCount,e.__renderId)}return e})}__runOnBeforeLeaveCallbacks(e,t,n,a){const r=C(t);return e.then(l=>{if(this.__isLatestRender(t))return At("onBeforeLeave",[r,n,this],a.element)(l)}).then(l=>{if(!(l||{}).redirect)return l})}__runOnBeforeEnterCallbacks(e,t,n,a){const r=C(t,a.route);return e.then(l=>{if(this.__isLatestRender(t))return At("onBeforeEnter",[r,n,this],a.element)(l)})}__isReusableElement(e,t){return e&&t?this.__createdByRouter.get(e)&&this.__createdByRouter.get(t)?e.localName===t.localName:e===t:!1}__isLatestRender(e){return e.__renderId===this.__lastStartedRenderId}__redirect(e,t,n){if(t>Vo)throw new Error(T(`Too many redirects when rendering ${e.from}`));return this.resolve({pathname:this.urlForPath(e.pathname,e.params),redirectFrom:e.from,__redirectCount:(t||0)+1,__renderId:n})}__ensureOutlet(e=this.__outlet){if(!(e instanceof Node))throw new TypeError(T(`Expected router outlet to be a valid DOM Node (but got ${e})`))}__updateBrowserHistory({pathname:e,search:t="",hash:n=""},a){if(window.location.pathname!==e||window.location.search!==t||window.location.hash!==n){const r=a?"replaceState":"pushState";window.history[r](null,document.title,e+t+n),window.dispatchEvent(new PopStateEvent("popstate",{state:"vaadin-router-ignore"}))}}__copyUnchangedElements(e,t){let n=this.__outlet;for(let a=0;a<e.__divergedChainIndex;a++){const r=t&&t.chain[a].element;if(r)if(r.parentNode===n)e.chain[a].element=r,n=r;else break}return n}__addAppearingContent(e,t){this.__ensureOutlet(),this.__removeAppearingContent();const n=this.__copyUnchangedElements(e,t);this.__appearingContent=[],this.__disappearingContent=Array.from(n.children).filter(r=>this.__addedByRouter.get(r)&&r!==e.result);let a=n;for(let r=e.__divergedChainIndex;r<e.chain.length;r++){const l=e.chain[r].element;l&&(a.appendChild(l),this.__addedByRouter.set(l,!0),a===n&&this.__appearingContent.push(l),a=l)}}__removeDisappearingContent(){this.__disappearingContent&&ve(this.__disappearingContent),this.__disappearingContent=null,this.__appearingContent=null}__removeAppearingContent(){this.__disappearingContent&&this.__appearingContent&&(ve(this.__appearingContent),this.__disappearingContent=null,this.__appearingContent=null)}__runOnAfterLeaveCallbacks(e,t){if(!!t)for(let n=t.chain.length-1;n>=e.__divergedChainIndex&&this.__isLatestRender(e);n--){const a=t.chain[n].element;if(!!a)try{const r=C(e);xe(a.onAfterLeave,[r,{},t.resolver],a)}finally{this.__disappearingContent.indexOf(a)>-1&&ve(a.children)}}}__runOnAfterEnterCallbacks(e){for(let t=e.__divergedChainIndex;t<e.chain.length&&this.__isLatestRender(e);t++){const n=e.chain[t].element||{},a=C(e,e.chain[t].route);xe(n.onAfterEnter,[a,{},e.resolver],n)}}__animateIfNeeded(e){const t=(this.__disappearingContent||[])[0],n=(this.__appearingContent||[])[0],a=[],r=e.chain;let l;for(let c=r.length;c>0;c--)if(r[c-1].route.animate){l=r[c-1].route.animate;break}if(t&&n&&l){const c=$e(l)&&l.leave||"leaving",i=$e(l)&&l.enter||"entering";a.push(xt(t,c)),a.push(xt(n,i))}return Promise.all(a).then(()=>e)}subscribe(){window.addEventListener("vaadin-router-go",this.__navigationEventHandler)}unsubscribe(){window.removeEventListener("vaadin-router-go",this.__navigationEventHandler)}__onNavigationEvent(e){const{pathname:t,search:n,hash:a}=e?e.detail:window.location;F(this.__normalizePathname(t))&&(e&&e.preventDefault&&e.preventDefault(),this.render({pathname:t,search:n,hash:a},!0))}static setTriggers(...e){jo(e)}urlForName(e,t){return this.__urlForName||(this.__urlForName=Mo(this)),_e(this.__urlForName(e,t),this)}urlForPath(e,t){return _e(N.pathToRegexp.compile(e)(t),this)}static go(e){const{pathname:t,search:n,hash:a}=F(e)?this.__createUrl(e,"http://a"):e;return ae("go",{pathname:t,search:n,hash:a})}}const Ko=/\/\*\*\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,Ae=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function Jo(){function o(){return!0}return Xt(o)}function Xo(){try{return Yo()?!0:Zo()?Ae?!Qo():!Jo():!1}catch{return!1}}function Yo(){return localStorage.getItem("vaadin.developmentmode.force")}function Zo(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function Qo(){return!!(Ae&&Object.keys(Ae).map(e=>Ae[e]).filter(e=>e.productionMode).length>0)}function Xt(o,e){if(typeof o!="function")return;const t=Ko.exec(o.toString());if(t)try{o=new Function(t[1])}catch(n){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",n)}return o(e)}window.Vaadin=window.Vaadin||{};const kt=function(o,e){if(window.Vaadin.developmentMode)return Xt(o,e)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=Xo());function en(){}const tn=function(){if(typeof kt=="function")return kt(en)};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.7.4"});tn();N.NavigationTrigger={POPSTATE:Ao,CLICK:xo};var Ne,w;(function(o){o.CONNECTED="connected",o.LOADING="loading",o.RECONNECTING="reconnecting",o.CONNECTION_LOST="connection-lost"})(w||(w={}));class on{constructor(e){this.stateChangeListeners=new Set,this.loadingCount=0,this.connectionState=e,this.serviceWorkerMessageListener=this.serviceWorkerMessageListener.bind(this),navigator.serviceWorker&&(navigator.serviceWorker.addEventListener("message",this.serviceWorkerMessageListener),navigator.serviceWorker.ready.then(t=>{var n;(n=t==null?void 0:t.active)===null||n===void 0||n.postMessage({method:"Vaadin.ServiceWorker.isConnectionLost",id:"Vaadin.ServiceWorker.isConnectionLost"})}))}addStateChangeListener(e){this.stateChangeListeners.add(e)}removeStateChangeListener(e){this.stateChangeListeners.delete(e)}loadingStarted(){this.state=w.LOADING,this.loadingCount+=1}loadingFinished(){this.decreaseLoadingCount(w.CONNECTED)}loadingFailed(){this.decreaseLoadingCount(w.CONNECTION_LOST)}decreaseLoadingCount(e){this.loadingCount>0&&(this.loadingCount-=1,this.loadingCount===0&&(this.state=e))}get state(){return this.connectionState}set state(e){if(e!==this.connectionState){const t=this.connectionState;this.connectionState=e,this.loadingCount=0;for(const n of this.stateChangeListeners)n(t,this.connectionState)}}get online(){return this.connectionState===w.CONNECTED||this.connectionState===w.LOADING}get offline(){return!this.online}serviceWorkerMessageListener(e){typeof e.data=="object"&&e.data.id==="Vaadin.ServiceWorker.isConnectionLost"&&(e.data.result===!0&&(this.state=w.CONNECTION_LOST),navigator.serviceWorker.removeEventListener("message",this.serviceWorkerMessageListener))}}const ye=window;!((Ne=ye.Vaadin)===null||Ne===void 0)&&Ne.connectionState||(ye.Vaadin=ye.Vaadin||{},ye.Vaadin.connectionState=new on(navigator.onLine?w.CONNECTED:w.CONNECTION_LOST));function L(o,e,t,n){var a=arguments.length,r=a<3?e:n===null?n=Object.getOwnPropertyDescriptor(e,t):n,l;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")r=Reflect.decorate(o,e,t,n);else for(var c=o.length-1;c>=0;c--)(l=o[c])&&(r=(a<3?l(r):a>3?l(e,t,r):l(e,t))||r);return a>3&&r&&Object.defineProperty(e,t,r),r}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const ke=window,Ze=ke.ShadowRoot&&(ke.ShadyCSS===void 0||ke.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Qe=Symbol(),Lt=new WeakMap;class et{constructor(e,t,n){if(this._$cssResult$=!0,n!==Qe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(Ze&&e===void 0){const n=t!==void 0&&t.length===1;n&&(e=Lt.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&Lt.set(t,e))}return e}toString(){return this.cssText}}const nn=o=>new et(typeof o=="string"?o:o+"",void 0,Qe),y=(o,...e)=>{const t=o.length===1?o[0]:e.reduce((n,a,r)=>n+(l=>{if(l._$cssResult$===!0)return l.cssText;if(typeof l=="number")return l;throw Error("Value passed to 'css' function must be a 'css' function result: "+l+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+o[r+1],o[0]);return new et(t,o,Qe)},an=(o,e)=>{Ze?o.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const n=document.createElement("style"),a=ke.litNonce;a!==void 0&&n.setAttribute("nonce",a),n.textContent=t.cssText,o.appendChild(n)})},St=Ze?o=>o:o=>o instanceof CSSStyleSheet?(e=>{let t="";for(const n of e.cssRules)t+=n.cssText;return nn(t)})(o):o;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Be;const Ce=window,Et=Ce.trustedTypes,rn=Et?Et.emptyScript:"",$t=Ce.reactiveElementPolyfillSupport,Je={toAttribute(o,e){switch(e){case Boolean:o=o?rn:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o)}return o},fromAttribute(o,e){let t=o;switch(e){case Boolean:t=o!==null;break;case Number:t=o===null?null:Number(o);break;case Object:case Array:try{t=JSON.parse(o)}catch{t=null}}return t}},Yt=(o,e)=>e!==o&&(e==e||o==o),Me={attribute:!0,type:String,converter:Je,reflect:!1,hasChanged:Yt};class J extends HTMLElement{constructor(){super(),this._$Ei=new Map,this.isUpdatePending=!1,this.hasUpdated=!1,this._$El=null,this.u()}static addInitializer(e){var t;(t=this.h)!==null&&t!==void 0||(this.h=[]),this.h.push(e)}static get observedAttributes(){this.finalize();const e=[];return this.elementProperties.forEach((t,n)=>{const a=this._$Ep(n,t);a!==void 0&&(this._$Ev.set(a,n),e.push(a))}),e}static createProperty(e,t=Me){if(t.state&&(t.attribute=!1),this.finalize(),this.elementProperties.set(e,t),!t.noAccessor&&!this.prototype.hasOwnProperty(e)){const n=typeof e=="symbol"?Symbol():"__"+e,a=this.getPropertyDescriptor(e,n,t);a!==void 0&&Object.defineProperty(this.prototype,e,a)}}static getPropertyDescriptor(e,t,n){return{get(){return this[t]},set(a){const r=this[e];this[t]=a,this.requestUpdate(e,r,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)||Me}static finalize(){if(this.hasOwnProperty("finalized"))return!1;this.finalized=!0;const e=Object.getPrototypeOf(this);if(e.finalize(),this.elementProperties=new Map(e.elementProperties),this._$Ev=new Map,this.hasOwnProperty("properties")){const t=this.properties,n=[...Object.getOwnPropertyNames(t),...Object.getOwnPropertySymbols(t)];for(const a of n)this.createProperty(a,t[a])}return this.elementStyles=this.finalizeStyles(this.styles),!0}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const n=new Set(e.flat(1/0).reverse());for(const a of n)t.unshift(St(a))}else e!==void 0&&t.push(St(e));return t}static _$Ep(e,t){const n=t.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}u(){var e;this._$E_=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$Eg(),this.requestUpdate(),(e=this.constructor.h)===null||e===void 0||e.forEach(t=>t(this))}addController(e){var t,n;((t=this._$ES)!==null&&t!==void 0?t:this._$ES=[]).push(e),this.renderRoot!==void 0&&this.isConnected&&((n=e.hostConnected)===null||n===void 0||n.call(e))}removeController(e){var t;(t=this._$ES)===null||t===void 0||t.splice(this._$ES.indexOf(e)>>>0,1)}_$Eg(){this.constructor.elementProperties.forEach((e,t)=>{this.hasOwnProperty(t)&&(this._$Ei.set(t,this[t]),delete this[t])})}createRenderRoot(){var e;const t=(e=this.shadowRoot)!==null&&e!==void 0?e:this.attachShadow(this.constructor.shadowRootOptions);return an(t,this.constructor.elementStyles),t}connectedCallback(){var e;this.renderRoot===void 0&&(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$ES)===null||e===void 0||e.forEach(t=>{var n;return(n=t.hostConnected)===null||n===void 0?void 0:n.call(t)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$ES)===null||e===void 0||e.forEach(t=>{var n;return(n=t.hostDisconnected)===null||n===void 0?void 0:n.call(t)})}attributeChangedCallback(e,t,n){this._$AK(e,n)}_$EO(e,t,n=Me){var a;const r=this.constructor._$Ep(e,n);if(r!==void 0&&n.reflect===!0){const l=(((a=n.converter)===null||a===void 0?void 0:a.toAttribute)!==void 0?n.converter:Je).toAttribute(t,n.type);this._$El=e,l==null?this.removeAttribute(r):this.setAttribute(r,l),this._$El=null}}_$AK(e,t){var n;const a=this.constructor,r=a._$Ev.get(e);if(r!==void 0&&this._$El!==r){const l=a.getPropertyOptions(r),c=typeof l.converter=="function"?{fromAttribute:l.converter}:((n=l.converter)===null||n===void 0?void 0:n.fromAttribute)!==void 0?l.converter:Je;this._$El=r,this[r]=c.fromAttribute(t,l.type),this._$El=null}}requestUpdate(e,t,n){let a=!0;e!==void 0&&(((n=n||this.constructor.getPropertyOptions(e)).hasChanged||Yt)(this[e],t)?(this._$AL.has(e)||this._$AL.set(e,t),n.reflect===!0&&this._$El!==e&&(this._$EC===void 0&&(this._$EC=new Map),this._$EC.set(e,n))):a=!1),!this.isUpdatePending&&a&&(this._$E_=this._$Ej())}async _$Ej(){this.isUpdatePending=!0;try{await this._$E_}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var e;if(!this.isUpdatePending)return;this.hasUpdated,this._$Ei&&(this._$Ei.forEach((a,r)=>this[r]=a),this._$Ei=void 0);let t=!1;const n=this._$AL;try{t=this.shouldUpdate(n),t?(this.willUpdate(n),(e=this._$ES)===null||e===void 0||e.forEach(a=>{var r;return(r=a.hostUpdate)===null||r===void 0?void 0:r.call(a)}),this.update(n)):this._$Ek()}catch(a){throw t=!1,this._$Ek(),a}t&&this._$AE(n)}willUpdate(e){}_$AE(e){var t;(t=this._$ES)===null||t===void 0||t.forEach(n=>{var a;return(a=n.hostUpdated)===null||a===void 0?void 0:a.call(n)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$Ek(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$E_}shouldUpdate(e){return!0}update(e){this._$EC!==void 0&&(this._$EC.forEach((t,n)=>this._$EO(n,this[n],t)),this._$EC=void 0),this._$Ek()}updated(e){}firstUpdated(e){}}J.finalized=!0,J.elementProperties=new Map,J.elementStyles=[],J.shadowRootOptions={mode:"open"},$t==null||$t({ReactiveElement:J}),((Be=Ce.reactiveElementVersions)!==null&&Be!==void 0?Be:Ce.reactiveElementVersions=[]).push("1.4.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var je;const ze=window,Z=ze.trustedTypes,Ct=Z?Z.createPolicy("lit-html",{createHTML:o=>o}):void 0,I=`lit$${(Math.random()+"").slice(9)}$`,Zt="?"+I,ln=`<${Zt}>`,Q=document,ie=(o="")=>Q.createComment(o),fe=o=>o===null||typeof o!="object"&&typeof o!="function",Qt=Array.isArray,fn=o=>Qt(o)||typeof(o==null?void 0:o[Symbol.iterator])=="function",oe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,zt=/-->/g,Ft=/>/g,B=RegExp(`>|[ 	
\f\r](?:([^\\s"'>=/]+)([ 	
\f\r]*=[ 	
\f\r]*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Tt=/'/g,Rt=/"/g,eo=/^(?:script|style|textarea|title)$/i,to=o=>(e,...t)=>({_$litType$:o,strings:e,values:t}),cn=to(1),ea=to(2),j=Symbol.for("lit-noChange"),v=Symbol.for("lit-nothing"),Ot=new WeakMap,sn=(o,e,t)=>{var n,a;const r=(n=t==null?void 0:t.renderBefore)!==null&&n!==void 0?n:e;let l=r._$litPart$;if(l===void 0){const c=(a=t==null?void 0:t.renderBefore)!==null&&a!==void 0?a:null;r._$litPart$=l=new de(e.insertBefore(ie(),c),c,void 0,t!=null?t:{})}return l._$AI(o),l},Y=Q.createTreeWalker(Q,129,null,!1),dn=(o,e)=>{const t=o.length-1,n=[];let a,r=e===2?"<svg>":"",l=oe;for(let i=0;i<t;i++){const f=o[i];let u,b,m=-1,h=0;for(;h<f.length&&(l.lastIndex=h,b=l.exec(f),b!==null);)h=l.lastIndex,l===oe?b[1]==="!--"?l=zt:b[1]!==void 0?l=Ft:b[2]!==void 0?(eo.test(b[2])&&(a=RegExp("</"+b[2],"g")),l=B):b[3]!==void 0&&(l=B):l===B?b[0]===">"?(l=a!=null?a:oe,m=-1):b[1]===void 0?m=-2:(m=l.lastIndex-b[2].length,u=b[1],l=b[3]===void 0?B:b[3]==='"'?Rt:Tt):l===Rt||l===Tt?l=B:l===zt||l===Ft?l=oe:(l=B,a=void 0);const O=l===B&&o[i+1].startsWith("/>")?" ":"";r+=l===oe?f+ln:m>=0?(n.push(u),f.slice(0,m)+"$lit$"+f.slice(m)+I+O):f+I+(m===-2?(n.push(void 0),i):O)}const c=r+(o[t]||"<?>")+(e===2?"</svg>":"");if(!Array.isArray(o)||!o.hasOwnProperty("raw"))throw Error("invalid template strings array");return[Ct!==void 0?Ct.createHTML(c):c,n]};class ce{constructor({strings:e,_$litType$:t},n){let a;this.parts=[];let r=0,l=0;const c=e.length-1,i=this.parts,[f,u]=dn(e,t);if(this.el=ce.createElement(f,n),Y.currentNode=this.el.content,t===2){const b=this.el.content,m=b.firstChild;m.remove(),b.append(...m.childNodes)}for(;(a=Y.nextNode())!==null&&i.length<c;){if(a.nodeType===1){if(a.hasAttributes()){const b=[];for(const m of a.getAttributeNames())if(m.endsWith("$lit$")||m.startsWith(I)){const h=u[l++];if(b.push(m),h!==void 0){const O=a.getAttribute(h.toLowerCase()+"$lit$").split(I),$=/([.?@])?(.*)/.exec(h);i.push({type:1,index:r,name:$[2],strings:O,ctor:$[1]==="."?bn:$[1]==="?"?hn:$[1]==="@"?pn:Fe})}else i.push({type:6,index:r})}for(const m of b)a.removeAttribute(m)}if(eo.test(a.tagName)){const b=a.textContent.split(I),m=b.length-1;if(m>0){a.textContent=Z?Z.emptyScript:"";for(let h=0;h<m;h++)a.append(b[h],ie()),Y.nextNode(),i.push({type:2,index:++r});a.append(b[m],ie())}}}else if(a.nodeType===8)if(a.data===Zt)i.push({type:2,index:r});else{let b=-1;for(;(b=a.data.indexOf(I,b+1))!==-1;)i.push({type:7,index:r}),b+=I.length-1}r++}}static createElement(e,t){const n=Q.createElement("template");return n.innerHTML=e,n}}function ee(o,e,t=o,n){var a,r,l,c;if(e===j)return e;let i=n!==void 0?(a=t._$Cl)===null||a===void 0?void 0:a[n]:t._$Cu;const f=fe(e)?void 0:e._$litDirective$;return(i==null?void 0:i.constructor)!==f&&((r=i==null?void 0:i._$AO)===null||r===void 0||r.call(i,!1),f===void 0?i=void 0:(i=new f(o),i._$AT(o,t,n)),n!==void 0?((l=(c=t)._$Cl)!==null&&l!==void 0?l:c._$Cl=[])[n]=i:t._$Cu=i),i!==void 0&&(e=ee(o,i._$AS(o,e.values),i,n)),e}class mn{constructor(e,t){this.v=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}p(e){var t;const{el:{content:n},parts:a}=this._$AD,r=((t=e==null?void 0:e.creationScope)!==null&&t!==void 0?t:Q).importNode(n,!0);Y.currentNode=r;let l=Y.nextNode(),c=0,i=0,f=a[0];for(;f!==void 0;){if(c===f.index){let u;f.type===2?u=new de(l,l.nextSibling,this,e):f.type===1?u=new f.ctor(l,f.name,f.strings,this,e):f.type===6&&(u=new gn(l,this,e)),this.v.push(u),f=a[++i]}c!==(f==null?void 0:f.index)&&(l=Y.nextNode(),c++)}return r}m(e){let t=0;for(const n of this.v)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,t),t+=n.strings.length-2):n._$AI(e[t])),t++}}class de{constructor(e,t,n,a){var r;this.type=2,this._$AH=v,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=n,this.options=a,this._$C_=(r=a==null?void 0:a.isConnected)===null||r===void 0||r}get _$AU(){var e,t;return(t=(e=this._$AM)===null||e===void 0?void 0:e._$AU)!==null&&t!==void 0?t:this._$C_}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=ee(this,e,t),fe(e)?e===v||e==null||e===""?(this._$AH!==v&&this._$AR(),this._$AH=v):e!==this._$AH&&e!==j&&this.$(e):e._$litType$!==void 0?this.T(e):e.nodeType!==void 0?this.k(e):fn(e)?this.O(e):this.$(e)}S(e,t=this._$AB){return this._$AA.parentNode.insertBefore(e,t)}k(e){this._$AH!==e&&(this._$AR(),this._$AH=this.S(e))}$(e){this._$AH!==v&&fe(this._$AH)?this._$AA.nextSibling.data=e:this.k(Q.createTextNode(e)),this._$AH=e}T(e){var t;const{values:n,_$litType$:a}=e,r=typeof a=="number"?this._$AC(e):(a.el===void 0&&(a.el=ce.createElement(a.h,this.options)),a);if(((t=this._$AH)===null||t===void 0?void 0:t._$AD)===r)this._$AH.m(n);else{const l=new mn(r,this),c=l.p(this.options);l.m(n),this.k(c),this._$AH=l}}_$AC(e){let t=Ot.get(e.strings);return t===void 0&&Ot.set(e.strings,t=new ce(e)),t}O(e){Qt(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let n,a=0;for(const r of e)a===t.length?t.push(n=new de(this.S(ie()),this.S(ie()),this,this.options)):n=t[a],n._$AI(r),a++;a<t.length&&(this._$AR(n&&n._$AB.nextSibling,a),t.length=a)}_$AR(e=this._$AA.nextSibling,t){var n;for((n=this._$AP)===null||n===void 0||n.call(this,!1,!0,t);e&&e!==this._$AB;){const a=e.nextSibling;e.remove(),e=a}}setConnected(e){var t;this._$AM===void 0&&(this._$C_=e,(t=this._$AP)===null||t===void 0||t.call(this,e))}}class Fe{constructor(e,t,n,a,r){this.type=1,this._$AH=v,this._$AN=void 0,this.element=e,this.name=t,this._$AM=a,this.options=r,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=v}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,n,a){const r=this.strings;let l=!1;if(r===void 0)e=ee(this,e,t,0),l=!fe(e)||e!==this._$AH&&e!==j,l&&(this._$AH=e);else{const c=e;let i,f;for(e=r[0],i=0;i<r.length-1;i++)f=ee(this,c[n+i],t,i),f===j&&(f=this._$AH[i]),l||(l=!fe(f)||f!==this._$AH[i]),f===v?e=v:e!==v&&(e+=(f!=null?f:"")+r[i+1]),this._$AH[i]=f}l&&!a&&this.P(e)}P(e){e===v?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e!=null?e:"")}}class bn extends Fe{constructor(){super(...arguments),this.type=3}P(e){this.element[this.name]=e===v?void 0:e}}const un=Z?Z.emptyScript:"";class hn extends Fe{constructor(){super(...arguments),this.type=4}P(e){e&&e!==v?this.element.setAttribute(this.name,un):this.element.removeAttribute(this.name)}}class pn extends Fe{constructor(e,t,n,a,r){super(e,t,n,a,r),this.type=5}_$AI(e,t=this){var n;if((e=(n=ee(this,e,t,0))!==null&&n!==void 0?n:v)===j)return;const a=this._$AH,r=e===v&&a!==v||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,l=e!==v&&(a===v||r);r&&this.element.removeEventListener(this.name,this,a),l&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,n;typeof this._$AH=="function"?this._$AH.call((n=(t=this.options)===null||t===void 0?void 0:t.host)!==null&&n!==void 0?n:this.element,e):this._$AH.handleEvent(e)}}class gn{constructor(e,t,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){ee(this,e)}}const Pt=ze.litHtmlPolyfillSupport;Pt==null||Pt(ce,de),((je=ze.litHtmlVersions)!==null&&je!==void 0?je:ze.litHtmlVersions=[]).push("2.3.1");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */var Ue,De;class re extends J{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var e,t;const n=super.createRenderRoot();return(e=(t=this.renderOptions).renderBefore)!==null&&e!==void 0||(t.renderBefore=n.firstChild),n}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=sn(t,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)===null||e===void 0||e.setConnected(!1)}render(){return j}}re.finalized=!0,re._$litElement$=!0,(Ue=globalThis.litElementHydrateSupport)===null||Ue===void 0||Ue.call(globalThis,{LitElement:re});const qt=globalThis.litElementPolyfillSupport;qt==null||qt({LitElement:re});((De=globalThis.litElementVersions)!==null&&De!==void 0?De:globalThis.litElementVersions=[]).push("3.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const wn=(o,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,o)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,o)}};function S(o){return(e,t)=>t!==void 0?((n,a,r)=>{a.constructor.createProperty(r,n)})(o,e,t):wn(o,e)}/**
 * @license
...
`;me("",ro,{moduleId:"lumo-typography"});const lo=document.createElement("template");lo.innerHTML=`<style>${qn.toString().replace(":host","html")}</style>`;document.head.appendChild(lo.content);/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const In=y`
...
`,io=document.createElement("template");io.innerHTML=`<style>${In.toString().replace(":host","html")}</style>`;document.head.appendChild(io.content);const tt=y`
  [theme~='dark'] {
    /* Base (background) */
...
`;me("",tt,{moduleId:"lumo-color"});const Nn=y`
  :host {
    color: var(--lumo-body-text-color) !important;
    background-color: var(--lumo-base-color) !important;
  }
`;me("",[tt,Nn],{moduleId:"lumo-color-legacy"});/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const fo=y`
...
`,so=document.createElement("template");so.innerHTML=`<style>${Bn.toString().replace(":host","html")}</style>`;document.head.appendChild(so.content);/**
 * @license
 * Copyright (c) 2017 - 2022 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const mo=y`
...
${Gn}
${Kn}
`;me("",bo,{moduleId:"lumo-utility"});const Jn=(o,e)=>{const t=/(?:@media\s(.+?))?(?:\s{)?\@import\s*(?:url\(\s*['"]?(.+?)['"]?\s*\)|(["'])((?:\\.|[^\\])*?)\3)([^;]*);(?:})?/g;for(var n,a=o;(n=t.exec(o))!==null;){a=a.replace(n[0],"");const r=document.createElement("link");r.rel="stylesheet",r.href=n[2]||n[4];const l=n[1]||n[5];l&&(r.media=l),e===document?document.head.appendChild(r):e.appendChild(r)}return a},K=(o,e,t)=>{if(e===document){const a=Xn(o);if(window.Vaadin.theme.injectedGlobalCss.indexOf(a)!==-1)return;window.Vaadin.theme.injectedGlobalCss.push(a)}const n=new CSSStyleSheet;n.replaceSync(Jn(o,e)),t?e.adoptedStyleSheets=[n,...e.adoptedStyleSheets]:e.adoptedStyleSheets=[...e.adoptedStyleSheets,n]};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];function Nt(o){let e,t,n=2166136261;for(e=0,t=o.length;e<t;e++)n^=o.charCodeAt(e),n+=(n<<1)+(n<<4)+(n<<7)+(n<<8)+(n<<24);return("0000000"+(n>>>0).toString(16)).substr(-8)}function Xn(o){let e=Nt(o);return e+Nt(e+o)}const Yn=o=>{K(En.toString(),o),document._vaadintheme_myapp_componentCss||(document._vaadintheme_myapp_componentCss=!0),K(ro.cssText,o,!0),K(tt.cssText,o,!0),K(fo.cssText,o,!0),K(mo.cssText,o,!0),K(bo.cssText,o,!0)},Zn=Yn;Zn(document);export{sn as A,oa as T,We as _,xn as a,v as b,tt as c,vn as d,S as e,yn as f,Cn as g,oo as h,y as i,nn as j,me as r,re as s,ro as t,ea as w,j as x,cn as y};
